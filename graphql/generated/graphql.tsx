...
export type RegisterMutationVariables = Exact<{
  ...
  existingCartItemsId?: InputMaybe<Array<Scalars['String']> | Scalars['String']>;
}>;


export type RegisterMutation = { __typename?: 'Mutation', register: { __typename: 'Error', message: string } | { __typename: 'MutationRegisterSuccess', data: { __typename?: 'User', email: string, id: string, token: string, cart: { __typename?: 'UserCart', id: string, userItems: Array<{ __typename?: 'CartItem', cartItemQuantity: number, item: { __typename?: 'ShopItem', itemDescription: string, itemId: string, itemImage: string, itemName: string, itemPrice: number } }> } } } };
...
export const RegisterDocument = gql`
    mutation Register($UserRegisterInput: UserRegisterInput!, $existingCartItemsId: [String!]) {
  register(input: $UserRegisterInput, existingCartItemsId: $existingCartItemsId) {
    __typename
    ... on Error {
      message
    }
 ...
 *      existingCartItemsId: // value for 'existingCartItemsId'
 *   },
 * });
 */
